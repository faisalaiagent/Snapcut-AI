...
import { WhiteBackgroundClient } from "./WhiteBackgroundClient";

export const metadata: Metadata = {
  title: "White Background Generator – Amazon & eBay Product Photos",
  description:
    "Generate pure white background product photos for Amazon, eBay, Etsy, and Shopify. AI removes the original background and centres your product automatically.",
};
...
export default function WhiteBackgroundPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="mb-8">
        <div className="section-tag">eCommerce Tool</div>
        ...
        <p className="text-[17px] text-ink-3 font-light max-w-xl">
          ...
          Supports Amazon, eBay, Etsy, and Shopify specifications.
        </p>
      </div>

      <WhiteBackgroundClient />

      <div className="mt-12 p-5 bg-gold-light border border-[#e8d0a0] rounded-2xl">
